...
SUBMISSION_PATH="submission_folder/external_tuning/caspr_adaptive/submission_shampoo.py"
SEARCH_SPACE_PATH="shampoo_jsons/tuning_search_space_shampoo_$1.json"
WORKLOAD="wmt"
DATA_DIR="~/data/wmt"
RNG_SEED="2"
