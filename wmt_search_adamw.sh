...
SUBMISSION_PATH="submission_folder/external_tuning/caspr_adaptive/jax_adamw_target_setting.py"
SEARCH_SPACE_PATH="adamw_jsons/tuning_search_space_adamw_$1.json"
WORKLOAD="wmt"
DATA_DIR="~/data/wmt"
RNG_SEED="2"
