...
EXP_NAME="eff_submission_across_caspr_hm_adaptive_full_matrix_wmt_search_$1"
SUBMISSION_PATH="submission_folder/external_tuning/caspr_adaptive/submission_across.py"
