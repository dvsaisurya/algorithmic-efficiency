...
EXP_DIR="/home/saisurya/Projects/algorithmic-efficiency/eff_caspr_hm_adaptive/eff_shampoo_imagenet_resnet_search"
EXP_NAME="eff_shampoo_imagenet_resnet_search_trial_$1"
SUBMISSION_PATH="prize_qualification_baselines/external_tuning/efficient_caspr_shampoo_dist_inv_target_setting_imagenet_resnet.py"
