...
from submission_folder.external_tuning.caspr_adaptive.caspr_adaptive_helper_modified import efficient_caspr_adaptive_full_matrix_dist_inv_optimized
...
def init_optimizer_state(workload: spec.Workload,
  ...
  lr_schedule_fn = jax_cosine_warmup_nested_learning_rate(workload.step_hint*0.375, workload.step_hint*0.53571619898,
                                      0.75*workload.step_hint , hyperparameters)
