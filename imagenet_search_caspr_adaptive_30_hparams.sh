...
EXP_NAME="eff_submission_caspr_hm_adaptive_full_matrix_imagenet_search_30_hparams_$1"
SUBMISSION_PATH="submission_folder/external_tuning/caspr_adaptive/submission_imagenet.py"
SEARCH_SPACE_PATH="caspr_adaptive_imagenet_stack_2_jsons/tuning_search_space_$1.json"
