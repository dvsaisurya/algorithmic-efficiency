...
EXP_NAME="eff_submission_shampoo_ext_full_matrix_wmt_search_$1"
SUBMISSION_PATH="submission_folder/external_tuning/caspr_adaptive/submission_shampoo_ext.py"
SEARCH_SPACE_PATH="nadamw_jsons/tuning_search_space_nadamw_$1.json"
WORKLOAD="wmt"
DATA_DIR="~/data/wmt"
RNG_SEED="2"
